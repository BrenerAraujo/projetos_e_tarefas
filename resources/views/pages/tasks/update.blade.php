...
@section('content')
    <div class="form-container">
        ...
        <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="entity-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description"
                          class="@error('description') is-invalid @enderror">{{ old('description', $task->description) }}</textarea>
                @error('description')
